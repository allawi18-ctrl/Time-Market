...
try{
 await page.goto('http://127.0.0.1:8000/qa/build18.html',{waitUntil:'domcontentloaded',timeout:180000});
 await page.waitForFunction(()=>window.__TM_READY__===true,null,{timeout:180000});
 await page.waitForTimeout(2800);await frame('build18-start.png');
 await page.keyboard.down('w');await page.waitForTimeout(1450);await page.keyboard.up('w');await page.waitForTimeout(650);await frame('build18-approach.png');
 await page.keyboard.down('w');await page.waitForTimeout(850);await page.keyboard.up('w');await page.waitForTimeout(500);await frame('build18-merchant-close.png');
 await page.keyboard.down('Shift');await page.keyboard.down('s');await page.waitForTimeout(900);await page.keyboard.up('s');await page.keyboard.up('Shift');await page.keyboard.down('a');await page.waitForTimeout(420);await page.keyboard.up('a');await page.waitForTimeout(900);await frame('build18-after-movement.png');

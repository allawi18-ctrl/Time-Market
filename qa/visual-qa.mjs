...
try{
 await page.goto('http://127.0.0.1:8000/qa/build10.html',{waitUntil:'domcontentloaded',timeout:180000});
 await page.waitForFunction(()=>window.__TM_READY__===true,null,{timeout:180000});
 await page.waitForTimeout(3200);await frame('build10-start.png');
 await page.keyboard.down('w');await page.waitForTimeout(2100);await page.keyboard.up('w');await page.waitForTimeout(550);await frame('build10-walk.png');
 await page.keyboard.down('Shift');await page.keyboard.down('w');await page.waitForTimeout(1400);await page.keyboard.up('w');await page.keyboard.up('Shift');await page.keyboard.down('d');await page.waitForTimeout(650);await page.keyboard.up('d');await page.waitForTimeout(1000);await frame('build10-after-movement.png');

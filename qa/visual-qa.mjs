...
try{
 await page.goto('http://127.0.0.1:8000/qa/human08-static.html',{waitUntil:'domcontentloaded',timeout:240000});
 await page.waitForFunction(()=>window.__TM_READY__===true,null,{timeout:240000});
 await page.waitForTimeout(2500);
 await page.screenshot({path:'qa-output/human-static-front.png',fullPage:false,timeout:30000});
 await page.waitForTimeout(3000);
 await page.screenshot({path:'qa-output/human-static-orbit.png',fullPage:false,timeout:30000});
